...
MIGRATION_MODULES = {"sites": "kkanbu.contrib.sites.migrations"}
...
ADMINS = [("""coding-kkanbu""", "ssamko@kakao.com")]
...
REST_FRAMEWORK = {
    "DEFAULT_AUTHENTICATION_CLASSES": (
        "kkanbu.accounts.authentication.CustomJWTCookieAuthentication",
    ),
